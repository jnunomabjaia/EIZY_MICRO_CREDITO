...
<html>
    ...
    <body>
        ...
        <div id="show-permissao" class="content scaffold-show" role="main">
            ...
            <f:display bean="permissao" />
            <g:form resource="${this.permissao}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.permissao}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
