...
<html>
    ...
    <body>
        ...
        <div id="show-tipoDocumento" class="content scaffold-show" role="main">
            ...
            <f:display bean="tipoDocumento" />
            <g:form resource="${this.tipoDocumento}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tipoDocumento}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
