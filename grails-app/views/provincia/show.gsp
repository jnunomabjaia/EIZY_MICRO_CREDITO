...
<html>
    ...
    <body>
        ...
        <div id="show-provincia" class="content scaffold-show" role="main">
            ...
            <f:display bean="provincia" />
            <g:form resource="${this.provincia}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.provincia}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
