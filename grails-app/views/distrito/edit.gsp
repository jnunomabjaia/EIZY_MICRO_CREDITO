...
<html>
    ...
    <body>
        ...
        <div id="edit-distrito" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.distrito}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.distrito}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.distrito}" method="PUT">
                <g:hiddenField name="version" value="${this.distrito?.version}" />
                <fieldset class="form">
                    <f:all bean="distrito"/>
                </fieldset>
