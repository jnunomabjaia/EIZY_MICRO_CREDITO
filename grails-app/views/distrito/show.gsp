...
<html>
    ...
    <body>
        ...
        <div id="show-distrito" class="content scaffold-show" role="main">
            ...
            <f:display bean="distrito" />
            <g:form resource="${this.distrito}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.distrito}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
